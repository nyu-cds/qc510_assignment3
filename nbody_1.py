"""
    ...
    I took the nested loop inside of advance function, and took the compute_b compute_energy functions out to avoid function call overhead. 

    The runtime is 64.85. Which is the most improvement. 
