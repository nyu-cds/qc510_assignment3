"""
    ...
    Alternatives to membership testing of lists. change list to set. 

    The runtime is 91.88212 seconds. 

    It is the third best improvement. 
"""
